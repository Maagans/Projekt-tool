...
export const CalendarIcon = ({ className }: { className?: string }) => (
  <svg {...iconProps} className={className || iconProps.className}><rect x="3" y="4" width="18" height="18" rx="2" ry="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /></svg>
);
...
export const WarningTriangleIcon = ({ className }: { className?: string }) => (
  <svg {...iconProps} className={className || iconProps.className}><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" /><line x1="12" y1="9" x2="12" y2="13" /><line x1="12" y1="17" x2="12.01" y2="17" /></svg>
);
...
export const UsersIcon = ({ className }: { className?: string }) => (
  <svg {...iconProps} className={className || iconProps.className}><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 00-3-3.87" /><path d="M16 3.13a4 4 0 010 7.75" /></svg>
);
...
export const FolderOpenIcon = ({ className }: { className?: string }) => (
  <svg {...iconProps} className={className || iconProps.className}><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
);
...
export const ClockIcon = ({ className }: { className?: string }) => (
  <svg {...iconProps} className={className || iconProps.className}><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>
);
