...
const timeEntries = [
  {
    ...
    weeks: [
      { key: '2025-W03', planned: 22, actual: 21 },
      { key: '2025-W04', planned: 20, actual: 19 },
      { key: '2025-W05', planned: 18, actual: 18 },
    ],
  },
  {
    memberKey: 'digital-hr-platform.linea-skov',
    weeks: [
      { key: '2025-W03', planned: 18, actual: 17 },
      { key: '2025-W04', planned: 18, actual: 18 },
      { key: '2025-W05', planned: 18, actual: 17 },
    ],
  },
  {
    memberKey: 'digital-hr-platform.ahmed-yasin',
    weeks: [
      { key: '2025-W03', planned: 32, actual: 30 },
      { key: '2025-W04', planned: 32, actual: 31 },
      { key: '2025-W05', planned: 30, actual: 29 },
    ],
  },
  {
    memberKey: 'digital-hr-platform.maria-jorgensen',
    weeks: [
      { key: '2025-W03', planned: 24, actual: 23 },
      { key: '2025-W04', planned: 24, actual: 24 },
      { key: '2025-W05', planned: 22, actual: 21 },
    ],
  },
  {
    memberKey: 'digital-hr-platform.julie-sand',
    weeks: [
      { key: '2025-W03', planned: 6, actual: 5 },
      { key: '2025-W04', planned: 6, actual: 6 },
      { key: '2025-W05', planned: 6, actual: 5 },
    ],
  },
  {
    memberKey: 'cloud-data-warehouse.sofia-birk',
    weeks: [
      { key: '2025-W02', planned: 24, actual: 24 },
      { key: '2025-W03', planned: 24, actual: 25 },
      { key: '2025-W04', planned: 22, actual: 21 },
    ],
  },
  {
    memberKey: 'cloud-data-warehouse.rasmus-lund',
    weeks: [
      { key: '2025-W02', planned: 32, actual: 31 },
      { key: '2025-W03', planned: 32, actual: 33 },
      { key: '2025-W04', planned: 30, actual: 29 },
    ],
  },
  {
    memberKey: 'cloud-data-warehouse.frederik-hald',
    weeks: [
      { key: '2025-W02', planned: 20, actual: 19 },
      { key: '2025-W03', planned: 20, actual: 19 },
      { key: '2025-W04', planned: 18, actual: 17 },
    ],
  },
  {
    memberKey: 'cloud-data-warehouse.nina-iversen',
    weeks: [
      { key: '2025-W02', planned: 20, actual: 18 },
      { key: '2025-W03', planned: 22, actual: 21 },
      { key: '2025-W04', planned: 20, actual: 20 },
    ],
  },
  {
    ...
    weeks: [
      { key: '2025-W03', planned: 20, actual: 19 },
      { key: '2025-W04', planned: 20, actual: 21 },
      { key: '2025-W05', planned: 18, actual: 18 },
    ],
  },
  {
    ...
    weeks: [
      { key: '2025-W03', planned: 26, actual: 25 },
      { key: '2025-W04', planned: 26, actual: 27 },
      { key: '2025-W05', planned: 24, actual: 23 },
    ],
  },
  {
    memberKey: 'citizen-engagement-app.rasmus-lund',
    weeks: [
      { key: '2025-W03', planned: 28, actual: 26 },
      { key: '2025-W04', planned: 28, actual: 28 },
      { key: '2025-W05', planned: 26, actual: 24 },
    ],
  },
  {
    ...
    weeks: [
      { key: '2025-W03', planned: 22, actual: 21 },
      { key: '2025-W04', planned: 22, actual: 22 },
      { key: '2025-W05', planned: 20, actual: 20 },
    ],
  },
  {
    memberKey: 'citizen-engagement-app.ahmed-yasin',
    weeks: [
      { key: '2025-W03', planned: 30, actual: 29 },
      { key: '2025-W04', planned: 30, actual: 30 },
      { key: '2025-W05', planned: 28, actual: 27 },
    ],
  },
  {
    memberKey: 'citizen-engagement-app.linea-skov',
    weeks: [
      { key: '2025-W03', planned: 18, actual: 18 },
      { key: '2025-W04', planned: 18, actual: 19 },
      { key: '2025-W05', planned: 18, actual: 18 },
    ],
  },
  {
...
const reportTemplates = [
  {
    ...
    deliverables: [
      { label: 'HR support playbook', position: 68 },
      { label: 'Pilot evaluering', position: 90 },
    ],
    kanban: [
  ...
  },
  {
    ...
    deliverables: [
      { label: 'Data katalog v1', position: 65 },
      { label: 'Support model', position: 80 },
    ],
    kanban: [
  ...
  for (const employee of employees) {
    const result = await client.query(
      `
        ...
        ON CONFLICT ON CONSTRAINT idx_employees_email_unique_ci
        DO UPDATE SET
          name = EXCLUDED.name,
  ...
  for (const user of demoUsers) {
    ...
    await client.query(
      `
        ...
        VALUES ($1, $2, $3, $4, $5)
        ON CONFLICT ON CONSTRAINT idx_users_email_unique_ci
        DO UPDATE SET
          name = EXCLUDED.name,
          role = EXCLUDED.role,
...
const seedReports = async (client, projectIds) => {
  for (const report of reportTemplates) {
    ...
    if (report.statusItems) {
      for (let index = 0; index < report.statusItems.length; index += 1) {
        const content = report.statusItems[index];
        await client.query(
          `
            INSERT INTO report_status_items (report_id, position, content)
            VALUES ($1, $2, $3)
          `,
    ...
    if (report.challengeItems) {
      for (let index = 0; index < report.challengeItems.length; index += 1) {
        const content = report.challengeItems[index];
        await client.query(
          `
    ...
    if (report.mainTableRows) {
      for (let index = 0; index < report.mainTableRows.length; index += 1) {
        const row = report.mainTableRows[index];
        await client.query(
          `
            INSERT INTO report_main_table_rows (report_id, position, title, status, note)
            VALUES ($1, $2, $3, $4, $5)
          `,
          [reportId, index, row.title, row.status, row.note ?? null],
        );
      }
    }
    ...
    if (report.risks) {
      for (const risk of report.risks) {
        await client.query(
          `
            INSERT INTO report_risks (report_id, name, probability, consequence)
            VALUES ($1, $2, $3, $4)
          `,
          [reportId, risk.name, risk.probability, risk.consequence],
        );
      }
    }
    ...
    if (report.phases) {
      for (const phase of report.phases) {
        await client.query(
          `
            INSERT INTO report_phases (report_id, label, start_percentage, end_percentage, highlight)
            VALUES ($1, $2, $3, $4, $5)
          `,
          [reportId, phase.label, phase.start, phase.end, phase.highlight],
        );
      }
    }
    ...
    if (report.milestones) {
      for (const milestone of report.milestones) {
        await client.query(
          `
            INSERT INTO report_milestones (report_id, label, position_percentage)
            VALUES ($1, $2, $3)
          `,
          [reportId, milestone.label, milestone.position],
        );
      }
    }
    ...
    if (report.deliverables) {
      for (const deliverable of report.deliverables) {
        await client.query(
          `
            INSERT INTO report_deliverables (report_id, label, position_percentage)
            VALUES ($1, $2, $3)
          `,
          [reportId, deliverable.label, deliverable.position],
        );
      }
    }
...
const seedDemoData = async () => {
  ...
  try {
    ...
    await seedReports(client, projectIds);
