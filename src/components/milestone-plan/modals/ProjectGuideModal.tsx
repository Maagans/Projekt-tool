...
import { X, Layers, Clock, Circle, CheckCircle2, ArrowRight, GitCommit } from 'lucide-react';
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-indigo-600 text-white">
                    <div>
                        ...
                        <p className="text-indigo-100 text-sm opacity-90">En hurtig guide til planlægningens byggeklodser.</p>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto p-8 bg-slate-50">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <p className="text-slate-600 text-sm mb-4 min-h-[40px]">
                                Den "bane" eller kategori arbejdet foregår i. Det grupperer opgaver sammen, f.eks. "IT", "Jura" eller "Marketing".
                            </p>
                            <div className="bg-slate-50 p-4 rounded-lg border border-slate-100">
                                <div className="text-xs font-bold text-slate-400 uppercase mb-2">Visuelt i planen:</div>
                        ...
                        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <p className="text-slate-600 text-sm mb-4 min-h-[40px]">
                                Det konkrete arbejde der tager tid. Har en start- og slutdato. Det er de farvede bjælker i planen.
                            </p>
                            <div className="bg-slate-50 p-4 rounded-lg border border-slate-100">
                                <div className="text-xs font-bold text-slate-400 uppercase mb-2">Visuelt i planen:</div>
                        ...
                        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-lg font-bold text-slate-800">4. Milepæl</h3>
                            </div>
                            <p className="text-slate-600 text-sm mb-4 min-h-[40px]">
                    ...
                    <div className="mt-8 p-4 bg-blue-50 border border-blue-100 rounded-xl flex gap-4 items-start">
                        ...
                        <div>
                            <h4 className="font-bold text-blue-900">Hvordan hænger det sammen?</h4>
                            <p className="text-sm text-blue-800 mt-1">
                                Du opretter <strong>Milepæle</strong> (diamanter) for at styre dine deadlines.
                                Inde i hver milepæl tilføjer du <strong>Aktiviteter</strong> (bjælker) for at vise arbejdet frem mod deadline.
                                Du bruger feltet <strong>"Workstream"</strong> på milepælen til at sortere den ned i den rigtige række (Indsats).
                            </p>
                        </div>
                    </div>
