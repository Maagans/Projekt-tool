...
export interface Deliverable {
    ...
    owner?: string | undefined;        // Ansvarlig
    ownerId?: string | undefined;      // Ansvarlig ID
    description?: string | undefined;  // Beskrivelse
    notes?: string | undefined;        // Noter
...
export interface Milestone {
    ...
    workstream?: string | undefined; // Now references the Workstream Name
