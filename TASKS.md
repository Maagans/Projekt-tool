...
- [ ] RM-012a: PMO-baseline for projektkapacitet
  ...
  - �ndringer:
    ...
    - Simpelt inputfelt (tal) under Ressource-ops�tning; validering = 0 og feedback p� gemt v�rdi.
  - Test (TDD):
...
- [ ] RM-012c: Hook & modeller til stacked data
  - Form�l: Eksponere baseline + stacked serier til frontend-komponenter.
  - �ndringer:
  ...
  - Test (TDD):
    1) Vitest for hook (happy path + tomme datas�t).
    2) Snapshot af helper-sortering og baseline fallback.
  - Afh�ngigheder: RM-012b.

- [ ] RM-012d: PMO-stacked chart
  - Form�l: Visualisere baseline vs. planlagt/faktisk belastning pr. projekt.
  - �ndringer:
    - Nyt kort i PMO-fanen: stacked area chart (planlagt + faktisk) med baseline-linje og badges for overstigende uger.
    - Tooltips viser projektnavn, uge, planlagt/faktisk + total; highlight n�r total > baseline.
  - Test (TDD):
    1) RTL-test der verificerer render/feature flag/alert n�r baseline overskrides.
    2) Visuel helper-test (fx farvepalet ordering).
  - Afh�ngigheder: RM-012c.

- [ ] RM-012e: Dokumentation & release-notes
  - Form�l: Beskrive baselinekonceptet og stacked kapacitetschart.
  - �ndringer:
    - README/CHANGELOG/Screenshots opdateres; TASKS markeres f�rdige.
    - Kort afsnit om hvordan PMO kan justere baseline og l�se grafen.
  - Test (TDD): Ikke-kode.
  - Afh�ngigheder: RM-012d.
